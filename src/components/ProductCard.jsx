...
const ProductCard = ({ title, sku, price, isSelected, onClick }) => {
  return (
    ...
    >
      ...
      <p style={{ margin: '5px 0 0', color: '#64748b', fontSize: '0.7rem', fontWeight: 600 }}>{sku}</p>
      <p style={{ margin: '8px 0 0', fontWeight: 'bold', color: isSelected ? '#34d399' : '#10b981', fontSize: '0.95rem' }}>
