import { BrowserRouter as Router, Routes, Route, useLocation } from "react-router-dom"; // 1. TAMBAHKAN useLocation
import { lazy, Suspense, useState, useEffect } from "react";
import "./App.css";
import "./components/version.css";

// Komponen biasa & Asset Tetap Di-import Normal
...
function App() {
  ...
  return (
    <Router>
      {/* 3. PASANG KOMPONEN DI SINI (Harus di dalam Router) */}
      <ScrollToTop />
      ...
      <Popup isOpen={isOpen} onClose={() => setIsOpen(false)}>
        <div style={{ textAlign: "center", padding: "10px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            <a href="https://wa.me/6281227347103" target="_blank" rel="noopener noreferrer" style={{ padding: "10px 20px", backgroundColor: "#25D366", color: "white", textDecoration: "none", borderRadius: "5px", fontWeight: "bold" }}>
              WhatsApp
            </a>
            <a href="https://t.me/" target="_blank" rel="noopener noreferrer" style={{ padding: "10px 20px", backgroundColor: "#2FA6D9", color: "white", textDecoration: "none", borderRadius: "5px", fontWeight: "bold" }}>
              Telegram
            </a>
            <a href="https://discord.com/" target="_blank" rel="noopener noreferrer" style={{ padding: "10px 20px", backgroundColor: "#5865F2", color: "white", textDecoration: "none", borderRadius: "5px", fontWeight: "bold" }}>
              Discord
            </a>
          </div>
        </div>
